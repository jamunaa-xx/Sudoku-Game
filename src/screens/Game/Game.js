...
const Game = () => {
  ...
  const [showNoSolutionFound, setShowNoSolutionFound] =
    useState(false);
  ...
  const handleSolve = () => {
    ...
    if (solvedStatus === false) {
      setShowNoSolutionFound((show) => !show);
      return;
    }
  ...
  const handleNewGame = (maxEmptyCellsCount) => {
    ...
    setShowDifficultySelect((show) => !show);
  };
  ...
  return (
    <div className="Game">
      ...
      {showNoSolutionFound && (
        <NoSolutionFound
          closeModal={() => setShowNoSolutionFound((show) => !show)}
        />
      )}

      {showDifficultySelect && (
        <DifficultySelect
          closeModal={() => setShowDifficultySelect((show) => !show)}
      ...
      <div className="action-container">
        ...
        />
        <Button
          onClick={() => setShowDifficultySelect((show) => !show)}
